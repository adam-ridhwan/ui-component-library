...
const CheckboxDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('checkbox');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Checkbox'} />
          <Heading>Checkbox</Heading>
          <Subheading>A control that allows the user to toggle between checked and not checked.</Subheading>
