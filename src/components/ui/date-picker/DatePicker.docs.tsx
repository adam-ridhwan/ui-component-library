...
const DatePickerDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('date-picker');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Date Picker'} />
          <Heading>Date Picker</Heading>
          <Subheading>A date picker component with range and presets.</Subheading>
