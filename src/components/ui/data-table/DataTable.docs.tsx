...
const DataTableDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('data-table');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Data Table'} />
          <Heading>Data Table</Heading>
          <Subheading>
            A table for displaying structured data with features such as sorting, filtering, and pagination.
          </Subheading>
