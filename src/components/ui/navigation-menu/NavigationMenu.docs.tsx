...
const NavigationMenuDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('navigation-menu');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Navigation Menu'} />
          <Heading>Navigation Menu</Heading>
          <Subheading>A collection of links for navigating websites.</Subheading>
