...
const ScrollAreaDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('scroll-area');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Scroll Area'} />
          <Heading>Scroll Area</Heading>
          <Subheading>Augments native scroll functionality for custom, cross-browser styling.</Subheading>
