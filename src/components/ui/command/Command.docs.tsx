...
const CommandDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('command');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Command'} />
          <Heading>Command</Heading>
          <Subheading>Fast, composable, un-styled command menu for React.</Subheading>
