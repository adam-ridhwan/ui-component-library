...
const ComboBoxDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('combo-box');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Combo Box'} />
          <Heading>Combo Box</Heading>
          <Subheading>Autocomplete input and command palette with a list of suggestions.</Subheading>
