...
const TextareaDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('textarea');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Textarea'} />
          <Heading>Textarea</Heading>
          <Subheading>Displays a form textarea or a component that looks like a textarea.</Subheading>
