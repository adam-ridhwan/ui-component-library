...
const InputDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('input');
    ...
    <>
      <ContentContainer>
        <SectionContainer>
          ...
          <Subheading>Displays a form input field or a component that looks like an input field.</Subheading>
