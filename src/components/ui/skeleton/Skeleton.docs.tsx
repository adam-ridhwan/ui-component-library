...
const SkeletonDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('skeleton');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Skeleton'} />
          <Heading>Skeleton</Heading>
          <Subheading>Use to show a placeholder while content is loading.</Subheading>
