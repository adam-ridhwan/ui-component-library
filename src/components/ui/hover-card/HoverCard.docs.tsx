...
const HoverCardDocs = () => {
  ...
  const [PREVIOUS_INDEX, NEXT_INDEX] = getPaginationIndex('hover-card');

  return (
    <>
      <ContentContainer>
        <SectionContainer>
          <Breadcrumbs section={'Hover Card'} />
          <Heading>Hover Card</Heading>
          <Subheading>For sighted users to preview content available behind a link.</Subheading>
